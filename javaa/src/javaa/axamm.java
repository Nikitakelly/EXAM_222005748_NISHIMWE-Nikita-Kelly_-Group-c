 ...
 * @author user1
 */
public class axamm extends javax.swing.JFrame {

    /**
     * Creates new form axamm
     */
    public axamm() {
        initComponents();
    }
    ...
    try {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/xjava","root","");
            PreparedStatement ps=con.prepareStatement("Delete from xjavaa where id=?");
    ...
    try{
        ...
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection con=DriverManager.getConnection("jdbc:mysql://localhost/xjava","root","");
        PreparedStatement ps=con.prepareStatement("insert into xjavaa(name,age,gender)values(?,?,?)");
        ps.setString(1,name);
        ps.setString(2,age);
    ...
    try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/xjava","root","");
            PreparedStatement ps=con.prepareStatement("Update xjavaa set name=?,age=?,gender=? where id=?");
            ps.setString(1, name);
            ps.setString(2, age);
           if(jRadioButton1.isSelected())
           {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(axamm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
